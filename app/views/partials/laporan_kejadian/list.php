...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Laporan Kejadian</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("laporan_kejadian/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New Laporan Kejadian 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('laporan_kejadian'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('laporan_kejadian'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="laporan_kejadian-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-tanggal_kejadian"> Tanggal Kejadian</th>
                                                <th  class="td-tanggal_entry_kejadian"> Tanggal Entry Kejadian</th>
                                                <th  class="td-lokasi_jalan"> Lokasi Jalan</th>
                                                <th  class="td-rt"> Rt</th>
                                                <th  class="td-rw"> Rw</th>
                                                <th  class="td-dusun"> Dusun</th>
                                                <th  class="td-desa_kelurahan"> Desa Kelurahan</th>
                                                <th  class="td-Kecamatan"> Kecamatan</th>
                                                <th  class="td-jenis_kejadian_bencana"> Jenis Kejadian Bencana</th>
                                                <th  class="td-kronologi_kejadian"> Kronologi Kejadian</th>
                                                <th  class="td-kerugian_usulan_rp"> Kerugian Usulan Rp</th>
                                                <th  class="td-kerugian_pengajuan_dana_td"> Kerugian Pengajuan Dana Td</th>
                                                <th  class="td-kerugian_realisasi"> Kerugian Realisasi</th>
                                                <th  class="td-data_korban_kerusakan"> Data Korban Kerusakan</th>
                                                <th  class="td-keterangan_bantuan"> Keterangan Bantuan</th>
                                                <th  class="td-petugas_entry"> Petugas Entry</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-tanggal_entry_kejadian">
                                                    ...
                                                    <td class="td-jenis_kejadian_bencana">
                                                    ...
                                                    <td class="td-kronologi_kejadian">
                                                    ...
                                                    <td class="td-kerugian_usulan_rp">
                                                    ...
                                                    <td class="td-kerugian_pengajuan_dana_td">
                                                    ...
                                                    <td class="td-kerugian_realisasi">
                                                    ...
                                                    <td class="td-data_korban_kerusakan">
                                                    ...
                                                    <td class="td-keterangan_bantuan">
                                                    ...
                                                    <th class="td-btn">
                                                        <?php if($can_view){ ?>
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("laporan_kejadian/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_edit){ ?>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("laporan_kejadian/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_delete){ ?>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("laporan_kejadian/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <?php if($can_delete){ ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("laporan_kejadian/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
